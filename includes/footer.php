  ...
  <script src="/Zadanie/vendor/jquery/jquery.min.js"></script>
  <script src="/Zadanie/vendor/bootstrap/js/bootstrap.min.js"></script>

  <script src="/Zadanie/assets/js/isotope.min.js"></script>
  <script src="/Zadanie/assets/js/owl-carousel.js"></script>

  <script src="/Zadanie/assets/js/tabs.js"></script>
  <script src="/Zadanie/assets/js/popup.js"></script>
  <script src="/Zadanie/assets/js/custom.js"></script>
  <script>
    setTimeout(function(){
        $('.loader').fadeToggle();
    }, 1500);
