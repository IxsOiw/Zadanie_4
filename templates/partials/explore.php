            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="main-image">                   
                        <img src="/Zadanie/assets/images/explore-item-01.jpg" alt="master bedroom design">
                    </div>
                ...
                <div class="col-lg-6">
                    <img src="/Zadanie/assets/images/explore-item-02.jpg" alt="">
                </div>
                <div class="col-lg-6">
                    <img src="/Zadanie/assets/images/explore-item-03.jpg" alt="">
                </div>
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="left-pagination">
                                    <img class="float-start" src="/Zadanie/assets/images/pagination-left-image.jpg" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="right-pagination">
                                    <img class="float-end" src="/Zadanie/assets/images/pagination-right-image.jpg" alt="">
