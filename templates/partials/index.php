<?php include '../../includes/header.php';?>
  ...
  <div class="search-form">
      <div class="container">
          <div class="row">
  <div class="col-lg-12"><?php include __DIR__ . '/../../includes/form.php';?> </div>
              </div>
          </div>
      </div>
  </div>
          ...
          <div class="row">
              ...
              <div class="col-lg-6">
                  <div class="left-image">
                      <img src="/Zadanie/assets/images/explore-work-left-image.jpg" alt="Interior Design Work">
                  </div>
              </div>
              <div class="col-lg-6">
                          ...
                          <li>
                              ...
                              <ul class="info">
                                  <li>
                                      ...
                                      <h6>
                                          <a href="/Zadanie/templates/partials/explore.php">
              ...
              <div class="col-lg-4">
                  <div class="right-image">
                      <div class="thumb">
                          ...
                          <img src="/Zadanie/assets/images/whats-trending-item-image.jpg" alt="">
                      </div>
                  </div>
              </div>
          </div>
